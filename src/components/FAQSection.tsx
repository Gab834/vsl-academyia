...
const faqs = [
  ...
  { q: "Por quanto tempo tenho acesso?", a: "Para sempre. É vitalício. Você paga R$497,90 uma única vez e tem acesso a tudo — incluindo todos os novos conteúdos adicionados no futuro. Sem mensalidade, sem prazo de expiração." },
